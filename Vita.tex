\documentclass[version=last, fontsize=10pt, paper=A4, toc=bibliography]{scrartcl}%
...
\item Matplotlib, \textscp{ggplot2}, Ti\emph{k}Z/PGF, PSTricks, gnuplot,
  Graphviz.
\end{itemize}
