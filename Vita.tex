\documentclass[paper=A4, fontsize=11pt, DIV=12, toc=bibliography]{scrartcl}%
...
\RequirePackage[autostyle, autopunct, strict]{csquotes}%
...
% Bibliography
\RequirePackage[hyperref, style=numeric, block=space, backend=biber,
datamodel=supervisor]{biblatex}%
...
\DeclareTextFontCommand{\textscp}{\scpfamily}%

\RedeclareSectionCommand[beforeskip=0.75em plus 0.75pt]{section}%
...
\rofoot{\texttt{(Typeset on \ISOToday)}}%
...
\begin{center}
  ...
  \begin{minipage}[c]{.3\columnwidth}
    ...
    \item[\faHome] Kruševska \textnumero~21
    \item 2320 Delčevo
    \item Macedonia
    \end{description}
  \end{minipage}%
...
{%
  ...
  compilers, machine learning, and cryptography.  Transcripts available upon
  request.  Publications:
  \autocites{Gjorgjevski:Combining_LWE-Solving_Algorithms,
...
\item[Proficient with]
  ...
  \item[R] \texttt{data.table}, \textscp{Tidyverse}, mlr, caret,
