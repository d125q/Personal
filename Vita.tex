...
\NewDocumentEnvironment{UniformTCBItems}{m}{%
  \begin{tcbitemize}[%
  raster columns={#1},%
...
\begin{minipage}[t]{0.575\textwidth}
    ...
    \item
      ...
      \begin{minipagebox}[16pt]{.25\linewidth}
        ...
        \begin{tikzpicture}[overlay,remember picture]
          \node[draw,rectangle,thick,dotted,fit=(Spark),%
          inner sep=6pt,%
          label={[align=center,scale=0.75]Apache Airflow},] (Scheduling) {};
        \end{tikzpicture}
      \end{minipagebox}%
      \hfill%
  ...
  {%
    ...
    \item Responsible for a self\-/hosted Vertica on Microsoft Azure:
      \begin{itemize}[nosep]
...
\begin{minipage}[t]{.4\textwidth}
  ...
  \begin{UniformTCBItems}{2}
    \tcbitem{}Python%
    \tcbitem{}GNU/Linux, AWS incl.\ CloudFormation%
