...
\newfontfamily\LSBSCFamily%
[Scale=MatchUppercase,Letters=SmallCaps,LetterSpace=3.0]%
...
\newbibmacro*{name:bold}[2]{%
  \def\do##1{%
    \iffieldequalstr{hash}{##1}{\LSBSCFamily\listbreak}{}%
  }%
...
\begin{minipage}[c]{0.75\textwidth}
  {\LSBSCFamily\Huge Dario Gjorgjevski\par}%
  \medskip%
  {\DSFamily\Large Curriculum vitæ\par}%
  \medskip%
  \begingroup%
